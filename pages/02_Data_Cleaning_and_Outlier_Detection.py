...
def main():
    ...
    sns.histplot(self_accident_quant["Latitude"], ax=ax[0], color="#7ABAFF")  # Light blue histogram
    ...
    sns.histplot(self_accident_quant["Longitude"], ax=ax[1], color="#7ABAFF")  # Light blue histogram
